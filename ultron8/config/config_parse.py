...
# from ultron8.config.config_utils import PartialConfigContext
# from ultron8.config.config_utils import StringFormatter
# from ultron8.config.config_utils import valid_bool
# from ultron8.config.config_utils import valid_dict
# from ultron8.config.config_utils import valid_float
# from ultron8.config.config_utils import valid_identifier
# from ultron8.config.config_utils import valid_int
# from ultron8.config.config_utils import valid_name_identifier
...
#     are, in turn, reconciled by ultron8.
#     """
#     config_class = Namedultron8Config
...
class ConfigContainer(object):
    ...
    def create(cls, config_mapping):
        ...
        return cls(dict(config_mapping))
