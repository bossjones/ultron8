...
from ultron8.actioncommand import ActionCommand
from ultron8.actioncommand import NoActionRunnerFactory
from ultron8.actioncommand import SubprocessActionRunnerFactory
from ultron8.config.config_utils import StringFormatter
from ultron8.config.schema import ExecutorTypes
from ultron8.core import action
from ultron8.eventbus import EventBus
from ultron8.mesos import MesosClusterRepository
from ultron8.serialize import filehandler
from ultron8.utils import maybe_decode
from ultron8.utils import proxy
from ultron8.utils import timeutils
from ultron8.utils.observer import Observable
from ultron8.utils.observer import Observer
from ultron8.utils.state import Machine
...
class ActionRun(Observable):
    ...
    FAILED_RENDER = 'false # Command failed to render correctly. See the ultron8 error log.'
