...
from ultron8.core import job
from ultron8.serialize import runstate
from ultron8.serialize.runstate.shelvestore import ShelveStateStore
from ultron8.serialize.runstate.yamlstore import YamlStateStore
from ultron8.utils import observer

log = logging.getLogger(__name__)


class VersionMismatchError(ValueError):
    """Raised when the state has a newer version then ultron8.__version.__."""
...
class PersistentStateManager(object):
    """Provides an interface to persist the state of ultron8.
